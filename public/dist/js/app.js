...
var adminLTE = angular.module('AdminLTE',['ui.router','chart.js','angular-flot','ui.bootstrap','ngResource']);
...
adminLTE.factory("UserInfoResource", function($resource) {
  return $resource("api/userInfo");
});

adminLTE.service('UserInfoService', function(UserInfoResource) {
  var self = {
    "userInfo": null,
    "loadUserInfo": function() {
      UserInfoResource.get(function(data) {
        console.log(data);
        self.userInfo = data;
      });
    }
...
/*
HeaderController*/
adminLTE.controller('HeaderController',function($scope, UserInfoService) {
  $scope.userInfoSvc = UserInfoService;
});

/*
NavBarController
*/
adminLTE.controller('NavBarController',function($scope, UserInfoService) {
  $scope.userInfoSvc = UserInfoService;
});
